<x-app-layout>
    <x-slot:title>
        {{auth()->user()->name}} Applications - Depozit.uz
    </x-slot:title>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <span class="font-bold text-xl text-blue-500">My Applications</span>
                    ...
                    <div class="mt-5">
                        ...
                        @foreach($applications as $application)
                            ...
                            <div class="rounded-xl border p-5 mt-5 shadow-md w-9/12 bg-white">
                                <div class="flex w-full items-center justify-between border-b pb-3">
                                    <div class="flex items-center space-x-3">
                                        <div class="h-10 w-10 rounded-full bg-slate-400">
                                            <img class="rounded-full" src="{{asset('storage/'.$application->user->photo)}}" alt="">
                                        </div>
                                        <div
                                ...
                                @else
                                    <hr class="border">
                                    <h3 class="text-xs font-bold mt-3 text-blue-400">Answer: </h3>
                                    <p class="mt-1">{{$application->answer->body}}</p>
                                @endif
                            </div>
                        @endforeach
